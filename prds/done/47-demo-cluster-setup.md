...
| 2026-03-12 | CRD timeout 1800s with transient failure tolerance | Cold starts pull ~37 container images. 1800s (30 min) timeout. Shell OR fallback (`crd_count=0`) prevents pipefail from killing the script on transient API server errors. |
